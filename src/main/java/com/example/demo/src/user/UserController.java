...
public class UserController {
    ...
    public BaseResponse<GetUserRes> getUser(@PathVariable("idx") int idx) {
    ...
    @ResponseBody
    @PatchMapping("/{idx}")
    public BaseResponse<String> modifyUserName(@PathVariable("idx") int idx, @RequestBody PatchUserReq patchUserReq) {
        try {
            ...
            //같다면 유저네임 변경
            userService.modifyUserName(patchUserReq, idx);
    ...
    @ResponseBody
    @DeleteMapping("/{idx}")
    public BaseResponse<String> deleteUser(@PathVariable("idx") int idx){
        try{
            userService.deleteUser(idx);
            String result = "회원 삭제 완료";
            return new BaseResponse<>(result);
        }catch(BaseException exception){
            return new BaseResponse<>((exception.getStatus()));
        }
